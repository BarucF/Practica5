...
public class MyApp {
	public static void run() {
		...
		System.out.println("Costo de lavado por botella:"+lavado.costoLavado(lavado.getCosto(), lavado.getTiempoCicloLavado())+"$");
		Llenado llenado=new Llenado("Maquina de llenado",LocalDate.of(2011,01,23),5000F,15,"100ml,500ml");
		System.out.println(llenado);
		System.out.println("Costo de llenado por botella:"+llenado.costoLlenado(llenado.getCosto(), llenado.getEnvasesXminuto())+"$");
		...
		System.out.println("Costo de empaquetado por botella:"+
		empaquetado.costoEmpaquetado(empaquetado.getCosto(), empaquetado.getTipoEmpaque(),empaquetado.getCantidadXminuto())+"$");
